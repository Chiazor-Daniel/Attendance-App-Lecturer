...
const FingerprintFailedScreen = ({ navigation }: any) => {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Fingerprint scanning failed. Please clean your finger and try again.
        </Text>

        <TouchableOpacity style={styles.retryButton} onPress={retryCapture}>
          <Text style={styles.retryButtonText}>Retry Fingerprint Scan</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
export default FingerprintFailedScreen;